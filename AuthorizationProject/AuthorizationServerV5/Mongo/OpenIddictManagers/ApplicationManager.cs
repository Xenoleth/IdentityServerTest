...
namespace AuthorizationServerV5.Mongo.OpenIddictManagers
{
        ...
        where TApplication : Application
    {
        ...
        /// </summary>
        //protected ApplicationStore<TApplication> Store { get; }
        ...
        /// </returns>
        public override Task<long> CountAsync<TResult>(Func<IQueryable<TApplication>, IQueryable<TResult>> query, CancellationToken cancellationToken)
        {
            if (query == null)
            {
        ...
        /// </returns>
        public override Task<TApplication> CreateAsync(TApplication application, CancellationToken cancellationToken)
        {
        ...
        /// whose result returns the unique identifier associated with the application.
        /// </returns>
        public override async Task<TApplication> CreateAsync(
        ...
        /// whose result returns the unique identifier associated with the application.
        /// </returns>
        public override async Task<TApplication> CreateAsync(OpenIddictApplicationDescriptor descriptor, CancellationToken cancellationToken)
        {
            if (descriptor == null)
            {
            ...
            TApplication application = new Application() as TApplication;
            if (application == null)
            {
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        public override async Task DeleteAsync(  TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        /// whose result returns the client application corresponding to the identifier.
        /// </returns>
        public override Task<TApplication> FindByClientIdAsync(  string identifier, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(identifier))
            {
                throw new ArgumentException("The identifier cannot be null or empty.", nameof(identifier));
        ...
        /// </returns>
        public override Task<ImmutableArray<TApplication>> FindByPostLogoutRedirectUriAsync(  string address, CancellationToken cancellationToken)
        {
        ...
        /// </returns>
        public override Task<ImmutableArray<TApplication>> FindByRedirectUriAsync(  string address, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(address))
            {
                throw new ArgumentException("The address cannot be null or empty.", nameof(address));
        ...
        /// </returns>
        //public override Task<TResult> GetAsync<TResult>(  Func<IQueryable<TApplication>, IQueryable<TResult>> query, CancellationToken cancellationToken)
        //{
        ...
        /// </returns>
        public override Task<string> GetClientIdAsync(  TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        /// </returns>
        public override async Task<string> GetClientTypeAsync(  TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        /// </returns>
        public override Task<string> GetDisplayNameAsync(  TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        /// whose result returns the unique identifier associated with the application.
        /// </returns>
        public override Task<string> GetIdAsync(  TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        public new async Task<bool> IsConfidentialAsync(  TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        public new async Task<bool> IsHybridAsync(  TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        public new async Task<bool> IsPublicAsync(  TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        /// </returns>
        public override Task<ImmutableArray<TApplication>> ListAsync(  int? count,   int? offset, CancellationToken cancellationToken)
        {
        ...
        /// whose result returns all the elements returned when executing the specified query.
        /// </returns>
        //public override Task<ImmutableArray<TResult>> ListAsync<TResult>(  Func<IQueryable<TApplication>, IQueryable<TResult>> query, CancellationToken cancellationToken)
        //{
        ...
        /// whose result returns all the elements returned when executing the specified query.
        /// </returns>
        //public override Task<ImmutableArray<TResult>> ListAsync<TState, TResult>(
        //      Func<IQueryable<TApplication>, TState, IQueryable<TResult>> query,
        //      TState state, CancellationToken cancellationToken)
        //{
        //    if (query == null)
        ...
        //    return Store.ListAsync(5, 5, cancellationToken);
        //}
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        public override async Task UpdateAsync(  TApplication application, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        public override async Task UpdateAsync(  TApplication application,
              string secret, CancellationToken cancellationToken)
        {
            if (application == null)
            {
        ...
        public virtual async Task UpdateAsync(  TApplication application,
              Func<OpenIddictApplicationDescriptor, Task> operation, CancellationToken cancellationToken)
        {
            if (operation == null)
            {
        ...
        /// </returns>
        public override async Task<bool> ValidateClientSecretAsync(
              TApplication application, string secret, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        /// </returns>
        public override async Task<bool> ValidatePostLogoutRedirectUriAsync(  string address, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(address))
            {
                throw new ArgumentException("The address cannot be null or empty.", nameof(address));
        ...
        /// </returns>
        public override async Task<bool> ValidateRedirectUriAsync(
              TApplication application,   string address, CancellationToken cancellationToken)
        {
            if (application == null)
            {
                throw new ArgumentNullException(nameof(application));
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        //protected override async Task PopulateAsync(Application application,
        //      OpenIddictApplicationDescriptor descriptor, CancellationToken cancellationToken)
        //{
        //    if (application == null)
        //    {
        //        throw new ArgumentNullException(nameof(application));
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        protected override async Task ValidateAsync(  TApplication application, CancellationToken cancellationToken)
        {
        ...
        /// A <see cref="Task"/> that can be used to monitor the asynchronous operation.
        /// </returns>
        protected override Task<string> ObfuscateClientSecretAsync(string secret, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(secret))
            {
        ...
        /// </returns>
        protected override Task<bool> ValidateClientSecretAsync(
            string secret, string comparand, CancellationToken cancellationToken)
        {
            if (string.IsNullOrEmpty(secret))
            {
                throw new ArgumentException("The secret cannot be null or empty.", nameof(secret));
